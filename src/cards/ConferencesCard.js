    ...
    return confs.map((conf, index) =>
      <div key={index} className="blockRow">
        ...
        <div className="rowDescription">
          <span className="rowItem"><IoIosPin className="rowItemIcon" /> {ConferenceLocation(conf)}</span>
          <span className="rowItem"><MdAccessTime className="rowItemIcon" /> {ConferenceDate(conf)}</span>
        </div>
