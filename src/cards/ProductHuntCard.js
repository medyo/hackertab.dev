        ...
        <div className="phItem">
          ...
          <div className="phContent">
            <CardLink
              ...
              appendRef={false}
              analyticsAttributes={{
                [Attributes.POINTS]: item.votesCount,
...
function ProductHuntCard({ label, icon, withAds }) {
  ...
  const renderItem = (item, index) => <ProductItem item={item} key={`ph-${index}`} index={index} />
